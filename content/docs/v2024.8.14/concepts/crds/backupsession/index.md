...
- Learn how backup of workloads data works from [here](/docs/v2024.8.14/guides/workloads/overview/).
- Learn how backup stand alone PVC works from [here](/docs/v2024.8.14/guides/volumes/overview/).
