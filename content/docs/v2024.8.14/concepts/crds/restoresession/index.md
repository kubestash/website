...
- Learn how restore of workloads data works from [here](/docs/v2024.8.14/guides/workloads/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2024.8.14/guides/volumes/overview/).
