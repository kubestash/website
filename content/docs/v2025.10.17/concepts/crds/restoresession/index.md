...
- Learn how restore of workloads data works from [here](/docs/v2025.10.17/guides/workloads/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2025.10.17/guides/volumes/overview/).
