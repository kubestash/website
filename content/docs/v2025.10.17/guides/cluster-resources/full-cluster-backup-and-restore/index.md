...
Please refer to the following [guide](/docs/v2025.10.17/guides/backends/azure/) to configure Microsoft Azure Backend Storage.
...
Please refer to the following [guide](/docs/v2025.10.17/guides/cluster-resources/configure-storage-and-rbac/#create-encryption-secret) to create a secret called `encrypt-secret` with the Restic password.

Please refer to the following [guide](/docs/v2025.10.17/guides/cluster-resources/configure-storage-and-rbac/#create-rbac-for-backupconfiguration) to configure the necessary RBAC permissions for `BackupConfiguration`.
...
>Notice the `spec.usagePolicy` that allows referencing the `RetentionPolicy` from all namespaces.For more details on configuring it for specific namespaces, please refer to the following [link](/docs/v2025.10.17/concepts/crds/retentionpolicy/).
...
KubeStash provides a [kubectl plugin](/docs/v2025.10.17/guides/cli/kubectl-plugin/#download-snapshot) for making it easy to download a snapshot locally.
...
Follow the `KubeStash` [official setup page](/docs/v2025.10.17/setup/install/kubestash/) for getting a license and installing `KubeStash`.
...
Please refer to the following [link](/docs/v2025.10.17/guides/backends/azure/) to configure Microsoft Azure Backend Storage.
...
Please refer to the following [guide](/docs/v2025.10.17/guides/cluster-resources/configure-storage-and-rbac/#create-rbac-for-backupconfiguration) to configure the necessary `RBAC` permissions for `RestoreSession`.
...
Follow the `KubeStash` [official setup page](/docs/v2025.10.17/setup/uninstall/kubestash/) to uninstall `KubeStash`.
