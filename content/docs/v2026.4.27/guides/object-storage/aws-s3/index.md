...
- Install `KubeStash` in your cluster following the steps [here](/docs/v2026.4.27/setup/README).
...
- You should be familiar with the following `KubeStash` concepts:
    - [BackupConfiguration](/docs/v2026.4.27/concepts/crds/backupconfiguration/)
    - [BackupSession](/docs/v2026.4.27/concepts/crds/backupsession/)
    - [RestoreSession](/docs/v2026.4.27/concepts/crds/restoresession/)
    - [BackupStorage](/docs/v2026.4.27/concepts/crds/backupstorage/)
    - [Snapshot](/docs/v2026.4.27/concepts/crds/snapshot/)
    - [RetentionPolicy](/docs/v2026.4.27/concepts/crds/retentionpolicy/)
...
We are going to use a `GCS` bucket. For this, we have to create a `Secret` with necessary credentials and a `BackupStorage` object. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2026.4.27/guides/backends/overview/).

> For GCS backend, if the bucket does not exist, KubeStash needs `Storage Object Admin` role permissions to create the bucket. For more details, please check the following [guide](/docs/v2026.4.27/guides/backends/gcs/).
...
Notice the `spec.usagePolicy` that allows referencing the `RetentionPolicy` from all namespaces.For more details on configuring it for specific namespaces, please refer to the following [RetentionPolicy usage policy](/docs/v2026.4.27/concepts/crds/retentionpolicy/).
