...
- You should be familiar with the following `KubeStash` concepts:
  ...
  - [BackupVerifier](/docs/v2026.4.27/concepts/crds/backupverifier/)
  - [BackupVerificationSession](/docs/v2026.4.27/concepts/crds/backupverificationsession/)
  - [RestoreSession](/docs/v2026.4.27/concepts/crds/restoresession/)
  - [Repository](/docs/v2026.4.27/concepts/crds/repository/)
