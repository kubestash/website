...
1. See a step by step guide to backup/restore volumes of a Deployment [here](/docs/v2025.7.31/guides/workloads/deployment/).
2. See a step by step guide to backup/restore volumes of a StatefulSet [here](/docs/v2025.7.31/guides/workloads/statefulset/).
3. See a step by step guide to backup/restore a DaemonSet's volumes [here](/docs/v2025.7.31/guides/workloads/daemonset/).
