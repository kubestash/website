...
url: /docs/v2025.7.31/addons/mariadb/
aliases:
- /docs/v2025.7.31/addons/mariadb/README/
info:
  cli: v0.19.0
...
- [How does it work?](/docs/v2025.7.31/addons/mariadb/overview/) gives an overview of how backup and restore process for MariaDB database works in KubeStash.
- [Standalone MariaDB Database](/docs/v2025.7.31/addons/mariadb/logical/) shows how to backup and restore an externally managed MariaDB database.