...
- Learn how restore of workloads data works from [here](/docs/v2025.7.31/guides/workloads/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2025.7.31/guides/volumes/overview/).
