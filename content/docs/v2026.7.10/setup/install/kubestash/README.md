...
url: /docs/v2026.7.10/setup/install/kubestash/
aliases:
- /docs/v2026.7.10/setup/install/kubestash/README/
info:
  cli: v0.28.0
...
- [Helm 3](/docs/v2026.7.10/setup/install/kubestash/helm) — recommended for most users.
- [YAML](/docs/v2026.7.10/setup/install/kubestash/yaml) — render manifests and apply with `kubectl`.
- [ArgoCD](/docs/v2026.7.10/setup/install/kubestash/argocd) — GitOps via ArgoCD `Application` resources.
- [FluxCD](/docs/v2026.7.10/setup/install/kubestash/fluxcd) — GitOps via the Flux Helm Controller.
- [OpenShift](/docs/v2026.7.10/setup/install/kubestash/openshift) — standard chart or Red Hat certified chart.

After installing, see [Common Configuration](/docs/v2026.7.10/setup/install/kubestash/configuration) to verify the installation.
