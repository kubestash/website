...
Once all three HelmReleases report `Ready`, follow the [Common Configuration](/docs/v2026.7.10/setup/install/kubestash/configuration) steps to verify the installation.
