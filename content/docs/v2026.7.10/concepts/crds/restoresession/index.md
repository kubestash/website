...
- Learn how restore of workloads data works from [here](/docs/v2026.7.10/guides/workloads/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2026.7.10/guides/volumes/overview/).
