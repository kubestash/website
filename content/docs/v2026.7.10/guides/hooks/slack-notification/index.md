...
- Install KubeStash in your cluster following the steps [here](/docs/v2026.7.10/setup/install/kubestash/_index).
- If you haven't read about how hooks work in KubeStash, please check it from [here](/docs/v2026.7.10/guides/hooks/overview/).
...
- [HookTemplate](/docs/v2026.7.10/concepts/crds/hooktemplate/)
...
We are going to store our backed up data into a GCS bucket. We have to create a Secret with necessary credentials and a BackupStorage crd to use this backend. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2026.7.10/guides/backends/overview/).
