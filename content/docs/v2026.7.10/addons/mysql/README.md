...
url: /docs/v2026.7.10/addons/mysql/
aliases:
- /docs/v2026.7.10/addons/mysql/README/
info:
  cli: v0.28.0
...
- [How does it work?](/docs/v2026.7.10/addons/mysql/overview/) gives an overview of how backup and restore process for MySQL database works in KubeStash.
- [Standalone MySQL Database](/docs/v2026.7.10/addons/mysql/logical/) shows how to backup and restore an externally managed MySQL database.