...
- Install `KubeStash` in your cluster following the steps [here](/docs/v2026.7.10/setup/install/kubestash/).
- Install KubeStash `kubectl` plugin following the steps [here](/docs/v2026.7.10/setup/install/kubectl-plugin/).
- If you are not familiar with how KubeStash backup and restore Elasticsearch databases, please check the following guide [here](/docs/v2026.7.10/addons/elasticsearch/overview/).
...
- [Addon](/docs/v2026.7.10/concepts/crds/addon/)
- [Function](/docs/v2026.7.10/concepts/crds/function/)
- [Task](/docs/v2026.7.10/concepts/crds/addon/#task-specification)
...
> **Note:** YAML files used in this tutorial are stored in [docs/addons/elasticsearch/logical/examples](/docs/v2026.7.10/addons/elasticsearch/logical/examples) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
<figure align="center">
  <img alt="Sample database in DigitalOcean" src="/docs/v2026.7.10/addons/elasticsearch/logical/images/sample-elasticsearch-database.svg">
...
We are going to store our backed up data into a GCS bucket. We have to create a Secret with necessary credentials and a `BackupStorage` CR to use this backend. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2026.7.10/guides/backends/overview/).
