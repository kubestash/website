...
<figure align="center">
  <img alt="Elasticsearch Backup Overview" src="/docs/v2026.7.10/addons/elasticsearch/overview/images/backup_overview.svg">
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v2026.7.10/addons/elasticsearch/overview/images/restore_overview.svg">
...
- Backup an externally managed `Elasticsearch` database using KubeStash by following the guides from [here](/docs/v2026.7.10/addons/elasticsearch/logical/).