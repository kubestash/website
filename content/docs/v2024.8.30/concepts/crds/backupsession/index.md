...
- Learn how backup of workloads data works from [here](/docs/v2024.8.30/guides/workloads/overview/).
- Learn how backup stand alone PVC works from [here](/docs/v2024.8.30/guides/volumes/overview/).
