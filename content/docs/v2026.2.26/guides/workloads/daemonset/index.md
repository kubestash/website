...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/workloads/daemonset/examples](/docs/v2026.2.26/guides/workloads/daemonset/examples) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
