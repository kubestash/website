...
For more details on how hook's action work in KubeStash and how to configure different types of hook, please visit [here](/docs/v2026.2.26/guides/hooks/overview/).
...
## Next Steps
- Learn how to configure `HookTemplate` for different use cases from [here](/docs/v2026.2.26/guides/hooks/configuring-hooks/).