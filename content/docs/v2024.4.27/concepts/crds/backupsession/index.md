...
- Learn how backup of workloads data works from [here](/docs/v2024.4.27/guides/workloads/overview/).
- Learn how backup stand alone PVC works from [here](/docs/v2024.4.27/guides/volumes/overview/).
