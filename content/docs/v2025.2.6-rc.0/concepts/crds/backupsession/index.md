...
- Learn how backup of workloads data works from [here](/docs/v2025.2.6-rc.0/guides/workloads/overview/).
- Learn how backup stand alone PVC works from [here](/docs/v2025.2.6-rc.0/guides/volumes/overview/).
