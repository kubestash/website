...
Hook is executed by a Job. We need to create a [Function](/docs/v2025.12.15/concepts/crds/function/) and refer it in [FunctionHookExecutorSpec](/docs/v2025.12.15/concepts/crds/hooktemplate/#specexecutor). This Function will be used to create the hook executor job.
