...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/volumes/pvc/examples](/docs/v2025.12.15/guides/volumes/pvc/examples) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
...
If you would like to uninstall KubeStash operator, please follow the steps [here](/docs/v2025.12.15/setup/README).
