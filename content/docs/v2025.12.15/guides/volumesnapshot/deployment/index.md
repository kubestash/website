...
- If you don't know how VolumeSnapshot works in KubeStash, please visit [here](/docs/v2025.12.15/guides/volumesnapshot/overview/).
- Install `KubeStash` in your cluster following the steps [here](/docs/v2025.12.15/setup/README).
- You should be familiar with the following `KubeStash` concepts:
  - [BackupStorage](/docs/v2025.12.15/concepts/crds/backupstorage/)
  - [BackupConfiguration](/docs/v2025.12.15/concepts/crds/backupconfiguration/)
  - [BackupSession](/docs/v2025.12.15/concepts/crds/backupsession/)
  - [Snapshot](/docs/v2025.12.15/concepts/crds/snapshot/)
  - [RestoreSession](/docs/v2025.12.15/concepts/crds/restoresession/)
  - [RetentionPolicy](/docs/v2025.12.15/concepts/crds/retentionpolicy/)
...
```
> Note: YAML files used in this tutorial are stored in [/docs/guides/volumesnapshot/pvc/examples](/docs/v2025.12.15/guides/volumesnapshot/statefulset/examples/) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
...
Now, we are going to take `VolumeSnapshot` of the Deployment `kubestash-deployment` PVCs using KubeStash. For this, we have to create a `Secret` with  necessary credentials and a `BackupStorage` object. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2025.12.15/guides/backends/overview/).

> For GCS backend, if the bucket does not exist, KubeStash needs `Storage Object Admin` role permissions to create the bucket. For more details, please check the following [guide](/docs/v2025.12.15/guides/backends/gcs/).
...
Notice the `spec.usagePolicy` that allows referencing the `RetentionPolicy` from all namespaces.For more details on configuring it for specific namespaces, please refer to the following [RetentionPolicy usage policy](/docs/v2025.12.15/concepts/crds/retentionpolicy/).
...
<figure align="center">
  <img alt="Snapshots in GCP" src="/docs/v2025.12.15/guides/volumesnapshot/statefulset/images/gcp.png">
