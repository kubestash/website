...
url: /docs/v2025.12.15/addons/mysql/
aliases:
- /docs/v2025.12.15/addons/mysql/README/
info:
  cli: v0.21.0
...
- [How does it work?](/docs/v2025.12.15/addons/mysql/overview/) gives an overview of how backup and restore process for MySQL database works in KubeStash.
- [Standalone MySQL Database](/docs/v2025.12.15/addons/mysql/logical/) shows how to backup and restore an externally managed MySQL database.