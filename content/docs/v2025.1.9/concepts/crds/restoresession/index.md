...
- Learn how restore of workloads data works from [here](/docs/v2025.1.9/guides/workloads/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2025.1.9/guides/volumes/overview/).
