...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/workloads/deployment/examples](/docs/v2025.1.9/guides/workloads/deployment/examples) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
