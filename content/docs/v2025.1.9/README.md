...
- [KubeStash Overview](/docs/v2025.1.9/concepts/what-is-kubestash/overview/) Provides an introduction to KubeStash and gives an overview of the features it provides.
- [KubeStash Architecture](/docs/v2025.1.9/concepts/what-is-kubestash/architecture/) Provides an overview of KubeStash architecture, and it's core components.
- [KubeStash API](/docs/v2025.1.9/concepts/crds/backupstorage/) Introduces KubeStash CRDs.
...
- **Install KubeStash:** Provides installation instructions for KubeStash and its various components.
  - [KubeStash](/docs/v2025.1.9/setup/install/kubestash/): Provides installation instructions for KubeStash.
  - [kubeStash kubectl Plugin](/docs/v2025.1.9/setup/install/kubectl-plugin/): Provides installation instructions for KubeStash `kubectl` plugin.
...
- **Uninstall KubeStash:** Provides uninstallation instructions for KubeStash and its various components.
  - [KubeStash](/docs/v2025.1.9/setup/uninstall/kubestash/): Provides uninstallation instructions for KubeStash.
  - [KubeStash kubectl Plugin](/docs/v2025.1.9/setup/uninstall/kubectl-plugin/): Provides uninstallation instructions for KubeStash `kubectl` plugin.
- [Upgrade KubeStash](/docs/v2025.1.9/setup/upgrade/): Provides instruction for updating KubeStash license and upgrading between various KubeStash versions.
...
- [Workload Volume Backup](/docs/v2025.1.9/guides/workloads/overview/): Shows how to use KubeStash to backup and restore volumes of a workload (i.e. `Deployment`, `StatefulSet`, `DaemonSet`, etc).
- [Stand-alone Volume Backup](/docs/v2025.1.9/guides/volumes/overview/): Shows how to use KubeStash to backup and restore stand-alone volumes(i.e. `PersistentVolumeClaim`).
...
- [Volume Snapshot](/docs/v2025.1.9/guides/volumesnapshot/overview/): Shows how KubeStash takes snapshot of `PersistentVolumeClaim`s and restore them from snapshot using Kubernetes `VolumeSnapshot` API.
- [Platforms](/docs/v2025.1.9/guides/platforms/eks-irsa/): Shows how to use KubeStash to backup and restore volumes of a Kubernetes workload running in different platforms.
...
- [CLI](/docs/v2025.1.9/guides/cli/kubectl-plugin/): Shows how to manage KubeStash objects quickly and easily using KubeStash `kubectl` plugin.
- [Security](/docs/v2025.1.9/guides/security/rbac/): Describes different built-in cluster security support by KubeStash.
