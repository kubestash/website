...
>For network volumes such as NFS, KubeStash needs to deploy a helper network volume accessor deployment in the same namespace as the BackupStorage. This deployment mounts the NFS volume, allowing the CLI to interact with the backend. You can configure the network volume accessor by following the instructions [here](/docs/v2024.12.9/setup/install/troubleshooting/#configuring-network-volume-accessor).

## Next Steps

- Learn how to use KubeStash to backup workloads data from [here](/docs/v2024.12.9/guides/workloads/overview/).
- Learn how to use KubeStash to backup stand-alone PVC from [here](/docs/v2024.12.9/guides/volumes/overview/).
