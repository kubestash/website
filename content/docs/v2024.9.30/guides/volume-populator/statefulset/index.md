...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/volume-populator/statefulset/examples](/docs/v2024.9.30/guides/volume-populator/statefulset/examples) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
