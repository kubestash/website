...
- Learn how restore of workloads data works from [here](/docs/v2024.9.30/guides/workloads/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2024.9.30/guides/volumes/overview/).
