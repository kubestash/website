...
<figure align="center">
  <img alt="PostgreSQL Backup Overview" src="/docs/v2025.12.9-rc.0/addons/postgres/overview/images/backup_overview.svg">
...
<figure align="center">
  <img alt="PostgreSQL Restore Overview" src="/docs/v2025.12.9-rc.0/addons/postgres/overview/images/restore_overview.svg">
...
- Backup an externally managed `PostgreSQL` database using KubeStash by following the guides from [here](/docs/v2025.12.9-rc.0/addons/postgres/logical/).