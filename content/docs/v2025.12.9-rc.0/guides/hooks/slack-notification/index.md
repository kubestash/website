...
- Install KubeStash in your cluster following the steps [here](/docs/v2025.12.9-rc.0/setup/install/kubestash/).
- If you haven't read about how hooks work in KubeStash, please check it from [here](/docs/v2025.12.9-rc.0/guides/hooks/overview/).
...
- [HookTemplate](/docs/v2025.12.9-rc.0/concepts/crds/hooktemplate/)
...
We are going to store our backed up data into a GCS bucket. We have to create a Secret with necessary credentials and a BackupStorage crd to use this backend. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2025.12.9-rc.0/guides/backends/overview/).
