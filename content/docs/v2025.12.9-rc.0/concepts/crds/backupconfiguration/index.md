...
- Learn how to configure `BackupConfiguration` to backup workloads data from [here](/docs/v2025.12.9-rc.0/guides/workloads/overview/).
- Learn how to configure `BackupConfiguration` to backup stand-alone PVC from [here](/docs/v2025.12.9-rc.0/guides/volumes/overview/).
