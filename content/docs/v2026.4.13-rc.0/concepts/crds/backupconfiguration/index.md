...
- Learn how to configure `BackupConfiguration` to backup workloads data from [here](/docs/v2026.4.13-rc.0/guides/workloads/overview/).
- Learn how to configure `BackupConfiguration` to backup stand-alone PVC from [here](/docs/v2026.4.13-rc.0/guides/volumes/overview/).
