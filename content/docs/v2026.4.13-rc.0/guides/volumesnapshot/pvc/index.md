...
> Note: YAML files used in this tutorial are stored in [/docs/guides/volumesnapshot/pvc/examples](/docs/v2026.4.13-rc.0/guides/volumesnapshot/pvc/examples/) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
...
<figure align="center">
  <img alt="Snapshots in GCP console" src="/docs/v2026.4.13-rc.0/guides/volumesnapshot/pvc/images/gcp.png">
