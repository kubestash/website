...
- If you don't know how VolumeSnapshot works in KubeStash, please visit [here](/docs/v2026.4.13-rc.0/guides/volumesnapshot/overview/).
...
```
> Note: YAML files used in this tutorial are stored in [/docs/guides/volumesnapshot/pvc/examples](/docs/v2026.4.13-rc.0/guides/volumesnapshot/statefulset/examples/) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
...
Now, we are going to take `VolumeSnapshot` of the StatefulSet `kubestash-demo` PVCs using KubeStash. For this, we have to create a `Secret` with  necessary credentials and a `BackupStorage` object. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2026.4.13-rc.0/guides/backends/overview/).
...
<figure align="center">
  <img alt="Snapshots in GCP" src="/docs/v2026.4.13-rc.0/guides/volumesnapshot/statefulset/images/gcp.png">
