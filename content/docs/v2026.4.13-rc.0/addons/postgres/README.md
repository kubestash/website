...
url: /docs/v2026.4.13-rc.0/addons/postgres/
aliases:
- /docs/v2026.4.13-rc.0/addons/postgres/README/
info:
  cli: v0.26.0-rc.0
...
- [How does it work?](/docs/v2026.4.13-rc.0/addons/postgres/overview/) gives an overview of how backup and restore process for PostgreSQL database works in KubeStash.
- [Standalone PostgreSQL Database](/docs/v2026.4.13-rc.0/addons/postgres/logical/) shows how to backup and restore an externally managed PostgreSQL database.