...
<figure align="center">
  <img alt="MySQL Backup Overview" src="/docs/v2026.4.13-rc.0/addons/mysql/overview/images/backup_overview.svg">
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v2026.4.13-rc.0/addons/mysql/overview/images/restore_overview.svg">
...
- Backup an externally managed `MySQL` database using KubeStash by following the guides from [here](/docs/v2026.4.13-rc.0/addons/mysql/logical/).
