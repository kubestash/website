...
- If you are not familiar with how KubeStash backup and restore Elasticsearch databases, please check the following guide [here](/docs/v2026.4.13-rc.0/addons/elasticsearch/overview/).
...
> **Note:** YAML files used in this tutorial are stored in [docs/addons/elasticsearch/logical/examples](/docs/v2026.4.13-rc.0/addons/elasticsearch/logical/examples) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
<figure align="center">
  <img alt="Sample database in DigitalOcean" src="/docs/v2026.4.13-rc.0/addons/elasticsearch/logical/images/sample-elasticsearch-database.svg">
