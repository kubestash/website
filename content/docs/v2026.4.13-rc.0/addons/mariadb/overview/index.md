...
<figure align="center">
  <img alt="MariaDB Backup Overview" src="/docs/v2026.4.13-rc.0/addons/mariadb/overview/images/backup_overview.svg">
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v2026.4.13-rc.0/addons/mariadb/overview/images/restore_overview.svg">
...
- Backup an externally managed `MariaDB` database using KubeStash by following the guides from [here](/docs/v2026.4.13-rc.0/addons/mariadb/logical/).
