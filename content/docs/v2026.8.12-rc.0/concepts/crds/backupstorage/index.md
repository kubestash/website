...
- **spec.storage :** `spec.storage` specifies the storage information where the backed up data will be stored. To learn how to configure `BackupStorage` crd for various storages, please visit [here](/docs/v2026.8.12-rc.0/guides/backends/overview).
...
## Next Steps
- Learn how to create `BackupStorage` for different storages from [here](/docs/v2026.8.12-rc.0/guides/backends/overview/).
- Learn how KubeStash backup workloads data from [here](/docs/v2026.8.12-rc.0/guides/workloads/overview/).
