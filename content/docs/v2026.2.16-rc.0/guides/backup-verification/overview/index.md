...
- You should be familiar with the following `KubeStash` concepts:
  ...
  - [BackupVerifier](/docs/v2026.2.16-rc.0/concepts/crds/backupverifier/)
  - [BackupVerificationSession](/docs/v2026.2.16-rc.0/concepts/crds/backupverificationsession/)
  - [RestoreSession](/docs/v2026.2.16-rc.0/concepts/crds/restoresession/)
  - [Repository](/docs/v2026.2.16-rc.0/concepts/crds/repository/)
