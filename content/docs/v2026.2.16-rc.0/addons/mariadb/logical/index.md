...
- If you are not familiar with how KubeStash backup and restore MariaDB databases, please check the following guide [here](/docs/v2026.2.16-rc.0/addons/mariadb/overview/).
...
> **Note:** YAML files used in this tutorial are stored in [docs/addons/mariadb/logical/examples](/docs/v2026.2.16-rc.0/addons/mariadb/logical/examples) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
