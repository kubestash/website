...
<figure align="center">
  <img alt="KubeStash Volume Populator Process Flow" src="/docs/v2026.2.27/guides/volume-populator/overview/images/volume-populator-overview.svg">
...
## Next Steps
1. See a step by step guide to populate the volume of a stand-alone PVC [here](/docs/v2026.2.27/guides/volume-populator/pvc/).
2. See a step by step guide to populate the volumes of a Deployment [here](/docs/v2026.2.27/guides/volume-populator/deployment/).
3. See a step by step guide to populate the volumes of a StatefulSet [here](/docs/v2026.2.27/guides/volume-populator/statefulset/).
