...
7. Finally, KubeStash starts rest of the standard backup process as discussed in [here](/docs/v2026.1.19/guides/workloads/overview/).

## Next Step

- Learn how to configure automatic backup for workloads from [here](/docs/v2026.1.19/guides/auto-backup/workload/).
- Learn how to configure automatic backup for PVCs from [here](/docs/v2026.1.19/guides/auto-backup/pvc/).
