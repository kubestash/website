...
- Learn how restore of workloads data works from [here](/docs/v2026.1.19/guides/workloads/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2026.1.19/guides/volumes/overview/).
