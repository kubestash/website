...
`spec.runtimeSettings` allow to specify Resources, NodeSelector, Affinity, Toleration, ReadinessProbe etc. To know more about the fields in `runtimeSettings`, see [Runtime Settings](/docs/v2025.3.19-rc.0/concepts/crds/backupconfiguration#runtime-settings)

## Next Steps

- Learn how backup of workloads data works from [here](/docs/v2025.3.19-rc.0/guides/workloads/overview/).
- Learn how backup stand alone PVC works from [here](/docs/v2025.3.19-rc.0/guides/volumes/overview/).
