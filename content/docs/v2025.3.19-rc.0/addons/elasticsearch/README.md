...
url: /docs/v2025.3.19-rc.0/addons/elasticsearch/
aliases:
- /docs/v2025.3.19-rc.0/addons/elasticsearch/README/
info:
  cli: v0.16.0-rc.0
...
- [How does it work?](/docs/v2025.3.19-rc.0/addons/elasticsearch/overview/) gives an overview of how backup and restore process for Elasticsearch database works in Stash.
- [Standalone Elasticsearch Database](/docs/v2025.3.19-rc.0/addons/elasticsearch/logical/) shows how to backup and restore an externally managed Elasticsearch database.