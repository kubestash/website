...
- At first user creates a [BackupStorage](/docs/v2025.6.30/concepts/crds/backupstorage/) object that contains the backend information along with a `Secret` object containing the corresponding backend credentials required for accessing the backend.
