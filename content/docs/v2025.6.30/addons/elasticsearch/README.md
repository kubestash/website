...
- [Standalone Elasticsearch Database](/docs/v2025.6.30/addons/elasticsearch/logical/) shows how to backup and restore an externally managed Elasticsearch database.