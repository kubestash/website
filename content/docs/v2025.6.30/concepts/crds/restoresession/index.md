...
- Learn how restore of workloads data works from [here](/docs/v2025.6.30/guides/workloads/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2025.6.30/guides/volumes/overview/).
