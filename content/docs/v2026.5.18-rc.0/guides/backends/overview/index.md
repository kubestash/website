...
- At first user creates a [BackupStorage](/docs/v2026.5.18-rc.0/concepts/crds/backupstorage/) object that contains the backend information along with a `Secret` object containing the corresponding backend credentials required for accessing the backend.
...
## Next Steps
- Learn how to configure `Kubernetes Volume` as backend from [here](/docs/v2026.5.18-rc.0/guides/backends/local/).
- Learn how to configure `AWS S3/Minio/Rook` backend from [here](/docs/v2026.5.18-rc.0/guides/backends/s3/).
- Learn how to configure `Google Cloud Storage (GCS)` backend from [here](/docs/v2026.5.18-rc.0/guides/backends/gcs/).
- Learn how to configure `Microsoft Azure Storage` backend from [here](/docs/v2026.5.18-rc.0/guides/backends/azure/).
