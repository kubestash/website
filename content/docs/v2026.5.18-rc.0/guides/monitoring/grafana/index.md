...
- At first, you need to setup a Prometheus monitoring stack in your cluster. Please, follow the [Prometheus Operator](/docs/v2026.5.18-rc.0/guides/monitoring/prom-operator/) guide to setup your monitoring stack if you haven't done already.
- Then, install KubeStash with monitoring enabled. Please, follow [this guide](/docs/v2026.5.18-rc.0/guides/monitoring/prom-operator/#enable-monitoring-in-kubestash) if you haven't done already.
...
<figure align="center">
  <img alt="Import KubeStash Grafana Dashboard: Step 2" src="/docs/v2026.5.18-rc.0/guides/monitoring/grafana/images/import_dashboard_2.png">
...
<figure align="center">
  <img alt="KubeStash Grafana Dashboard" src="/docs/v2026.5.18-rc.0/guides/monitoring/grafana/images/kubestash_grafana_dashboard.png">
