...
Once all three HelmReleases report `Ready`, follow the [Common Configuration](/docs/v2026.5.18-rc.0/setup/install/kubestash/configuration) steps to verify the installation.
