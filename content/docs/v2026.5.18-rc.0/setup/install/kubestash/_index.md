...
- [Helm 3](/docs/v2026.5.18-rc.0/setup/install/kubestash/helm) — recommended for most users.
- [YAML](/docs/v2026.5.18-rc.0/setup/install/kubestash/yaml) — render manifests and apply with `kubectl`.
- [ArgoCD](/docs/v2026.5.18-rc.0/setup/install/kubestash/argocd) — GitOps via ArgoCD `Application` resources.
- [FluxCD](/docs/v2026.5.18-rc.0/setup/install/kubestash/fluxcd) — GitOps via the Flux Helm Controller.
- [OpenShift](/docs/v2026.5.18-rc.0/setup/install/kubestash/openshift) — standard chart or Red Hat certified chart.

After installing, see [Common Configuration](/docs/v2026.5.18-rc.0/setup/install/kubestash/configuration) to verify the installation.
