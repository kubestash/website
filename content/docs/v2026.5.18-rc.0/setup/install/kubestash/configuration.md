...
The steps below apply regardless of which [installation method](/docs/v2026.5.18-rc.0/setup/install/kubestash/) you used.
...
Now, you are ready to [take your first backup](/docs/v2026.5.18-rc.0/guides/README) using KubeStash.
