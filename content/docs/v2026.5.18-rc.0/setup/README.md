...
url: /docs/v2026.5.18-rc.0/setup/
aliases:
- /docs/v2026.5.18-rc.0/setup/README/
info:
  cli: v0.27.0-rc.0
...
- **Uninstall KubeStash:** Uninstallation instructions for KubeStash and its various components.
  - [KubeStash operator](/docs/v2026.5.18-rc.0/setup/uninstall/kubestash/): Installation instructions for KubeStash operator.
  - [KubeStash kubectl Plugin](/docs/v2026.5.18-rc.0/setup/uninstall/kubectl-plugin/): Uninstallation instructions for KubeStash `kubectl` plugin.

- [Upgrading KubeStash](/docs/v2026.5.18-rc.0/setup/upgrade/): Instructions for updating KubeStash license and upgrading between various KubeStash versions.
