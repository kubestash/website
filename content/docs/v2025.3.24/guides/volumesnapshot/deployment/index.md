...
- If you don't know how VolumeSnapshot works in KubeStash, please visit [here](/docs/v2025.3.24/guides/volumesnapshot/overview/).
- Install `KubeStash` in your cluster following the steps [here](/docs/v2025.3.24/setup/README).
...
```
> Note: YAML files used in this tutorial are stored in [/docs/guides/volumesnapshot/pvc/examples](/docs/v2025.3.24/guides/volumesnapshot/statefulset/examples/) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
...
Notice the `spec.usagePolicy` that allows referencing the `RetentionPolicy` from all namespaces.For more details on configuring it for specific namespaces, please refer to the following [RetentionPolicy usage policy](/docs/v2025.3.24/concepts/crds/retentionpolicy/).
...
<figure align="center">
  <img alt="Snapshots in GCP" src="/docs/v2025.3.24/guides/volumesnapshot/statefulset/images/gcp.png">
