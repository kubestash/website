...
<figure align="center">
  <img alt="KubeDump Backup Overview" src="/docs/v2025.3.24/guides/kubedump/overview/images/kubedump-backup.svg">
...
- Backup the YAMLs of a particular application using KubeStash following the guide from [here](/docs/v2025.3.24/guides/kubedump/application/).
- Backup the YAMLs of an entire Namespace using KubeStash following the guide from [here](/docs/v2025.3.24/guides/kubedump/namespace/).
- Backup the YAMLs of your entire Kubernetes cluster using KubeStash following the guide from [here](/docs/v2025.3.24/guides/kubedump/cluster/).
