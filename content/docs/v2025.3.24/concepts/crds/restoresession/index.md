...
- Learn how restore of workloads data works from [here](/docs/v2025.3.24/guides/workloads/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2025.3.24/guides/volumes/overview/).
