...
url: /docs/v2026.6.18-rc.2/addons/elasticsearch/
aliases:
- /docs/v2026.6.18-rc.2/addons/elasticsearch/README/
info:
  cli: v0.27.0-rc.2
...
- [How does it work?](/docs/v2026.6.18-rc.2/addons/elasticsearch/overview/) gives an overview of how backup and restore process for Elasticsearch database works in Stash.
- [Standalone Elasticsearch Database](/docs/v2026.6.18-rc.2/addons/elasticsearch/logical/) shows how to backup and restore an externally managed Elasticsearch database.