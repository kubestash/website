...
url: /docs/v2026.6.18-rc.2/addons/mysql/
aliases:
- /docs/v2026.6.18-rc.2/addons/mysql/README/
info:
  cli: v0.27.0-rc.2
...
- [How does it work?](/docs/v2026.6.18-rc.2/addons/mysql/overview/) gives an overview of how backup and restore process for MySQL database works in KubeStash.
- [Standalone MySQL Database](/docs/v2026.6.18-rc.2/addons/mysql/logical/) shows how to backup and restore an externally managed MySQL database.