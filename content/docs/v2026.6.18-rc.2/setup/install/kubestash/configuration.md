...
The steps below apply regardless of which [installation method](/docs/v2026.6.18-rc.2/setup/install/kubestash/) you used.
...
Now, you are ready to [take your first backup](/docs/v2026.6.18-rc.2/guides/README) using KubeStash.
