...
> Note: You can configure additional runtime settings for restore jobs within the `addon.jobTemplate.spec` sections. For further details, please refer to the [reference](/docs/v2026.6.18-rc.2/concepts/crds/restoresession/#podtemplate-spec).