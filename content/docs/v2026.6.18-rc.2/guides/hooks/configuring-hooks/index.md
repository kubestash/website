...
Hook is executed by a Job. We need to create a [Function](/docs/v2026.6.18-rc.2/concepts/crds/function/) and refer it in [FunctionHookExecutorSpec](/docs/v2026.6.18-rc.2/concepts/crds/hooktemplate/#specexecutor). This Function will be used to create the hook executor job.
