...
* **PVC Volumes:** [PVC Volume Backup & Restore](/docs/v2026.6.18-rc.2/guides/volumes/pvc/)
* **Workload's Volumes:** [Workload's Volumes Backup & Restore](/docs/v2026.6.18-rc.2/guides/workloads/overview/)
...
Please refer to the following [guide](/docs/v2026.6.18-rc.2/guides/backends/azure/) to configure Microsoft Azure Backend Storage.
...
Please refer to the following [guide](/docs/v2026.6.18-rc.2/guides/cluster-resources/configure-storage-and-rbac/#create-encryption-secret) to create a secret called `encrypt-secret` with the Restic password.

Please refer to the following [guide](/docs/v2026.6.18-rc.2/guides/cluster-resources/configure-storage-and-rbac/#create-rbac-for-backupconfiguration) to configure the necessary RBAC permissions for `BackupConfiguration`.
...
>Notice the `spec.usagePolicy` that allows referencing the `RetentionPolicy` from all namespaces.For more details on configuring it for specific namespaces, please refer to the following [link](/docs/v2026.6.18-rc.2/concepts/crds/retentionpolicy/).
...
KubeStash provides a [kubectl plugin](/docs/v2026.6.18-rc.2/guides/cli/kubectl-plugin/#download-snapshot) for making it easy to download a snapshot locally.
...
Follow the `KubeStash` [official setup page](/docs/v2026.6.18-rc.2/setup/install/kubestash/) for getting a license and installing `KubeStash`.
...
Please refer to the following [link](/docs/v2026.6.18-rc.2/guides/backends/azure/) to configure Microsoft Azure Backend Storage.
...
Please refer to the following [guide](/docs/v2026.6.18-rc.2/guides/cluster-resources/configure-storage-and-rbac/#create-rbac-for-backupconfiguration) to configure the necessary `RBAC` permissions for `RestoreSession`.
...
Follow the `KubeStash` [official setup page](/docs/v2026.6.18-rc.2/setup/uninstall/kubestash/) to uninstall `KubeStash`.
