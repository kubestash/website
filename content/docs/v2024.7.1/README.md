...
url: /docs/v2024.7.1/welcome/
aliases:
- /docs/v2024.7.1/
- /docs/v2024.7.1/README/
info:
  cli: v0.9.0
  installer: v2024.7.1
  version: v2024.7.1
...
## [Concepts](/docs/v2024.7.1/concepts/)
...
- [KubeStash Overview](/docs/v2024.7.1/concepts/what-is-kubestash/overview/) Provides an introduction to KubeStash and gives an overview of the features it provides.
- [KubeStash Architecture](/docs/v2024.7.1/concepts/what-is-kubestash/architecture/) Provides an overview of KubeStash architecture, and it's core components.
- [KubeStash API](/docs/v2024.7.1/concepts/crds/backupstorage/) Introduces KubeStash CRDs.

## [Setup](/docs/v2024.7.1/setup/)
...
- **Install KubeStash:** Provides installation instructions for KubeStash and its various components.
  - [KubeStash](/docs/v2024.7.1/setup/install/kubestash/): Provides installation instructions for KubeStash.
  - [kubeStash kubectl Plugin](/docs/v2024.7.1/setup/install/kubectl-plugin/): Provides installation instructions for KubeStash `kubectl` plugin.
  - [Troubleshooting](/docs/v2024.7.1/setup/install/troubleshooting/): Provides troubleshooting guide for various installation problems.
- **Uninstall KubeStash:** Provides uninstallation instructions for KubeStash and its various components.
  - [KubeStash](/docs/v2024.7.1/setup/uninstall/kubestash/): Provides uninstallation instructions for KubeStash.
  - [KubeStash kubectl Plugin](/docs/v2024.7.1/setup/uninstall/kubectl-plugin/): Provides uninstallation instructions for KubeStash `kubectl` plugin.
- [Upgrade KubeStash](/docs/v2024.7.1/setup/upgrade/): Provides instruction for updating KubeStash license and upgrading between various KubeStash versions.

## [Guides](/docs/v2024.7.1/guides/)
