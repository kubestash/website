...
- Learn how backup of workloads data works from [here](/docs/v2024.7.1/guides/workloads/overview/).
- Learn how backup stand alone PVC works from [here](/docs/v2024.7.1/guides/volumes/overview/).
