...
- Learn how restore of workloads data works from [here](/docs/v2024.7.1/guides/workloads/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2024.7.1/guides/volumes/overview/).
