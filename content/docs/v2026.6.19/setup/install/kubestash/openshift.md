...
Use the standard [`kubestash` chart](/docs/v2026.6.19/setup/install/kubestash/helm) and enable the OpenShift distribution values. This switches the operator to UBI-based images and applies the SecurityContextConstraints and other OpenShift-specific tweaks:
...
Once installed, follow the [Common Configuration](/docs/v2026.6.19/setup/install/kubestash/configuration) steps to verify the operator and Addon catalogs are running.
