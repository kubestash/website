...
The steps below apply regardless of which [installation method](/docs/v2026.6.19/setup/install/kubestash/) you used.
...
KubeStash can run fully disconnected from the internet, as long as every required image is cached in a registry the cluster can reach (see the [offline installation guide](/docs/v2026.6.19/setup/install/kubestash/helm)).
...
Now, you are ready to [take your first backup](/docs/v2026.6.19/guides/README) using KubeStash.
