...
Once all three Applications are healthy, follow the [Common Configuration](/docs/v2026.6.19/setup/install/kubestash/configuration) steps to verify the installation.
