...
- Learn how restore of workloads data works from [here](/docs/v2024.6.4/guides/workloads/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2024.6.4/guides/volumes/overview/).
