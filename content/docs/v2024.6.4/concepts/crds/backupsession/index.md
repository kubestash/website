...
- Learn how backup of workloads data works from [here](/docs/v2024.6.4/guides/workloads/overview/).
- Learn how backup stand alone PVC works from [here](/docs/v2024.6.4/guides/volumes/overview/).
