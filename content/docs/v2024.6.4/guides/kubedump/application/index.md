...
- Install KubeStash in your cluster following the steps [here](/docs/v2024.6.4/setup/install/kubestash/).
- Install KubeStash `kubectl` plugin in your local machine following the steps [here](/docs/v2024.6.4/setup/install/kubectl-plugin/).
- If you are not familiar with how KubeStash backup the resource YAMLs, please check the following guide [here](/docs/v2024.6.4/guides/kubedump/overview/).

You have to be familiar with the following custom resources:

- [BackupStorage](/docs/v2024.6.4/concepts/crds/backupstorage/)
- [BackupConfiguration](/docs/v2024.6.4/concepts/crds/backupconfiguration/)
- [BackupSession](/docs/v2024.6.4/concepts/crds/backupsession/)
- [Snapshot](/docs/v2024.6.4/concepts/crds/snapshot/)
- [RestoreSession](/docs/v2024.6.4/concepts/crds/restoresession/)
- [RetentionPolicy](/docs/v2024.6.4/concepts/crds/retentionpolicy/)
...
Now, we are going backup of the YAMLs of an application to a GCS bucket using KubeStash. For this, we have to create a `Secret` with  necessary credentials and a `BackupStorage` object. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2024.6.4/guides/backends/overview/).

> For GCS backend, if the bucket does not exist, KubeStash needs `Storage Object Admin` role permissions to create the bucket. For more details, please check the following [guide](/docs/v2024.6.4/guides/backends/gcs/).
...
Notice the `spec.usagePolicy` that allows referencing the `RetentionPolicy` from all namespaces.For more details on configuring it for specific namespaces, please refer to the following [link](/docs/v2024.6.4/concepts/crds/retentionpolicy/).
...
<figure align="center">
  <img alt="Backup YAMLs data of an Application in GCS storage" src="/docs/v2024.6.4/guides/kubedump/application/images/application_manifest_backup.png">
...
KubeStash provides a [kubectl plugin](/docs/v2024.6.4/guides/cli/kubectl-plugin/#download-snapshot) for making it easy to download a snapshot locally.
