...
url: /docs/v2025.4.30/addons/postgres/
aliases:
- /docs/v2025.4.30/addons/postgres/README/
info:
  cli: v0.17.0
...
- [How does it work?](/docs/v2025.4.30/addons/postgres/overview/) gives an overview of how backup and restore process for PostgreSQL database works in KubeStash.
- [Standalone PostgreSQL Database](/docs/v2025.4.30/addons/postgres/logical/) shows how to backup and restore an externally managed PostgreSQL database.