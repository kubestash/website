...
<figure align="center">
  <img alt="KubeStash Backup Flow" src="/docs/v2025.4.30/guides/volumesnapshot/overview/images/volumesnapshot-overview.svg">
...
<figure align="center">
  <img alt="KubeStash Restore Flow" src="/docs/v2025.4.30/guides/volumesnapshot/overview/images/restore-overview.svg">
...
## Next Steps
1. See a step by step guide to snapshot a stand-alone PVC [here](/docs/v2025.4.30/guides/volumesnapshot/pvc/).
2. See a step by step guide to snapshot the volumes of a Deployment [here](/docs/v2025.4.30/guides/volumesnapshot/deployment/).
3. See a step by step guide to snapshot the volumes of a StatefulSet [here](/docs/v2025.4.30/guides/volumesnapshot/statefulset/).
