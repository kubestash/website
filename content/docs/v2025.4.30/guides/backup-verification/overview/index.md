...
- You should be familiar with the following `KubeStash` concepts:
  ...
  - [BackupVerifier](/docs/v2025.4.30/concepts/crds/backupverifier/)
  - [BackupVerificationSession](/docs/v2025.4.30/concepts/crds/backupverificationsession/)
  - [RestoreSession](/docs/v2025.4.30/concepts/crds/restoresession/)
  - [Repository](/docs/v2025.4.30/concepts/crds/repository/)
