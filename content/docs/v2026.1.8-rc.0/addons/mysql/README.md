...
url: /docs/v2026.1.8-rc.0/addons/mysql/
aliases:
- /docs/v2026.1.8-rc.0/addons/mysql/README/
info:
  cli: v0.22.0-rc.0
...
- [How does it work?](/docs/v2026.1.8-rc.0/addons/mysql/overview/) gives an overview of how backup and restore process for MySQL database works in KubeStash.
- [Standalone MySQL Database](/docs/v2026.1.8-rc.0/addons/mysql/logical/) shows how to backup and restore an externally managed MySQL database.