...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/volumes/pvc/examples](/docs/v2026.1.8-rc.0/guides/volumes/pvc/examples) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
...
If you would like to uninstall KubeStash operator, please follow the steps [here](/docs/v2026.1.8-rc.0/setup/README).
