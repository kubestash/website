...
- Learn how restore of workloads data works from [here](/docs/v2026.1.8-rc.0/guides/workloads/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2026.1.8-rc.0/guides/volumes/overview/).
